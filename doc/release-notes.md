Traw Core version 2.3.0 is now available from:

  <hhttps://github.com/BitcoinGOAT/Traw/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/BitcoinGOAT/Traw/issues>

Compatibility
==============

Traw Core is extensively tested on multiple operating systems using
...
Traw Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) Traw MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode Traw address
...
The third parameter indicates if the wallet should be unlocked for staking and anonymization only (true), or to allow traw operations (false, full unlock).

ZeroMQ (ZMQ) Notifications
--------------

trawd can now (optionally) asynchronously notify clients through a ZMQ-based PUB socket of the arrival of new transactions and blocks. This feature requires installation of the ZMQ C API library 4.x and configuring its use through the command line or configuration file. Please see [docs/zmq.md](/doc/zmq.md) for details of operation.
...
Traw Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Traw (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Traw (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/traw-project-translations/).
