...
6. Multitraw now can filter between staking and masternode rewards (soon). Also some bugs addressed.
...
10. Added Fallback Seed Nodes - You no longer need to add initial addnodes lines to traw.conf!
