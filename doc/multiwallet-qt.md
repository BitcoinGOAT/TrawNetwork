...
In order to support loading of multiple wallets in traw-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is traw.cpp.
...
This widget owns five page views: overviewPage, transactionsPage, addressBookPage, receiveCoinsPage, and trawCoinsPage.
...
Changes to traw.cpp
----------------------
traw.cpp is the entry point into traw-qt, and as such, will require some minor modifications to provide hooks for
