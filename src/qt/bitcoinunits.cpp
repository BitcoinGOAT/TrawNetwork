...
QString BitcoinUnits::id(int unit)
{
    ...
    case SEND:
        return QString("TRAW");
    case mSEND:
        return QString("mTRAW");
    case uSEND:
        return QString::fromUtf8("uTRAW");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case SEND:
            return QString("tTRAW");
        case mSEND:
            return QString("mtTRAW");
        case uSEND:
            return QString::fromUtf8("μtTRAW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SEND:
            return QString("TRAW");
        case mSEND:
            return QString("Milli-TRAW (1 / 1" THIN_SP_UTF8 "000)");
        case uSEND:
            return QString("Micro-TRAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        ...
        case mSEND:
            return QString("Milli-TestTRAW (1 / 1" THIN_SP_UTF8 "000)");
        case uSEND:
            return QString("Micro-TestTRAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
