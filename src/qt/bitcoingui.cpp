                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Traw Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TRAW address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Traw Core"), this);
    aboutAction->setStatusTip(tr("Show information about Traw Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Traw"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TRAW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TRAW addresses"));
    ...
    openAction->setStatusTip(tr("Open a Traw: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Traw Core help message to get a list with possible Traw command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Traw Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Traw network", "", count));
}
...
{
    QString strTitle = tr("Traw Core"); // default title
