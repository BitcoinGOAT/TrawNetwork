...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total traw balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized traw balance of the wallet\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"trawaddress\"\n"
            "\nReturn information about the given traw address.\n"
            "\nArguments:\n"
            "1. \"trawaddress\"     (string, required) The skx address to validate\n"
            "\nResult:\n"
            "{\n"
