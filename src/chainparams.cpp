...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0xb3d3557a22a4d6afe1cfc82fd5c3a0bdaae2cc2bce3a4160c5f2f64210b08b6e"));
...
const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;
        ...
        strSporkKey = "04c523bd3a87b0adedd1f42d1d171e0346860c2e01762d036ed57226ca16726734106a8d1b84c8d6fbac82227dd9d85072ba86ee72f3818ca1e26e67907a7c5539";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // TRAW: 1 day
        nTargetSpacing = 1 * 60;  // TRAW: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x781a2536b1701ea6a9f6807438ebeb122fd8cc704a1a65a24e46f0204fcf076f"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("Node1", "63.209.35.28"));
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // TRAW: 1 day
        nTargetSpacing = 1 * 60;        // TRAW: 1 minutes
