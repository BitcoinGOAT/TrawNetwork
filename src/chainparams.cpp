...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "The TRAW Team! - The Real Always Wins!";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1523324281;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 1831645;

        hashGenesisBlock = genesis.GetHash();
	assert(hashGenesisBlock == uint256("0xbb346d51b685f518f8cc5550ccc9d96136adc260e1634f21f7edb709a48ccde8"));
        assert(genesis.hashMerkleRoot == uint256("0x4fb16765262a369aa807169e1cb98e613fe62cbf8cf31fb0ab91a6483aebac91"));

        vSeeds.push_back(CDNSSeedData("Seednode1", "104.219.248.187"));
        vSeeds.push_back(CDNSSeedData("Seednode2", "162.213.249.111"));
...
public:
    CTestNetParams() {
        ...
        assert(hashGenesisBlock == uint256("0x52843849c963c4cdce3d47b23ecd5d62905fc9fac452c105435525ab8d9d5568"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("0", "0"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // traw test net start with T
...
public:
    CRegTestParams() {
        ...
        strDataDir = "regtest";
//        MineGenesis(genesis);
        assert(hashGenesisBlock == uint256("0xc0811874b111c95e8ef65041e2b141b4c05d9598209818d864ea8d444d7c98b7"));
