...
#if defined(NDEBUG)
# error "Traw cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Traw Signed Message:\n";
...
{
	int64_t PreMine = 25000000 * COIN;
    if(pindexBest->nHeight == 1){return PreMine;} else {return 25*COIN;}
}

// miner's coin stake reward
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    return (2.5 * COIN) + nFees;
}
