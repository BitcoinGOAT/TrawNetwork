...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* traw features */
        {"traw", "masternode", &masternode, true, true, false},
        {"traw", "listmasternodes", &listmasternodes, true, true, false},
        {"traw", "getmasternodecount", &getmasternodecount, true, true, false},
        {"traw", "masternodeconnect", &masternodeconnect, true, true, false},
        {"traw", "masternodecurrent", &masternodecurrent, true, true, false},
        {"traw", "masternodedebug", &masternodedebug, true, true, false},
        {"traw", "startmasternode", &startmasternode, true, true, false},
        {"traw", "createmasternodekey", &createmasternodekey, true, true, false},
        {"traw", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"traw", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"traw", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"traw", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"traw", "getmasternodescores", &getmasternodescores, true, true, false},
        {"traw", "mnbudget", &mnbudget, true, true, false},
        {"traw", "preparebudget", &preparebudget, true, true, false},
        {"traw", "submitbudget", &submitbudget, true, true, false},
        {"traw", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"traw", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"traw", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"traw", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"traw", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"traw", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"traw", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"traw", "checkbudgets", &checkbudgets, true, true, false},
        {"traw", "mnsync", &mnsync, true, true, false},
        {"traw", "spork", &spork, true, true, false},
        {"traw", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"traw", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use trawd, or the -server option to traw-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> traw-cli " + methodname + " " + args + "\n";
}
