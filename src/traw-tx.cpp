...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Skullnodes Core traw-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  traw-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded send transaction") + "\n" +
                               "  traw-tx [options] -create [commands]   " + _("Create hex-encoded send transaction") + "\n" +
                               "\n";
