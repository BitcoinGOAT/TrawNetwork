/* src/config/traw-config.h.  Generated from traw-config.h.in by configure.  */
/* src/config/traw-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRAW_CONFIG_H

#define TRAW_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.traw.network"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Traw Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Traw Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "traw"
