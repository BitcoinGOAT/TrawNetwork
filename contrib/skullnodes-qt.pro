...
RESOURCES += src/qt/traw.qrc src/qt/traw_locale.qrc

TRANSLATIONS += src/qt/locale/traw_bg.ts \
                src/qt/locale/traw_de.ts \
                src/qt/locale/traw_en.ts \
                src/qt/locale/traw_es.ts \
                src/qt/locale/traw_fi.ts \
                src/qt/locale/traw_fr.ts \
                src/qt/locale/traw_it.ts \
                src/qt/locale/traw_ja.ts \
                src/qt/locale/traw_pl.ts \
                src/qt/locale/traw_pt.ts \
                src/qt/locale/traw_ru.ts \
                src/qt/locale/traw_sk.ts \
                src/qt/locale/traw_sv.ts \
                src/qt/locale/traw_vi.ts \
                src/qt/locale/traw_zh_CN.ts \
                src/qt/locale/traw_zh_TW.ts
